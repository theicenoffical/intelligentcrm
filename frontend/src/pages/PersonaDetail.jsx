  ...
  return (
    <>
      ...
      <div className="container-x pt-28">
        <Link to="/solutions" data-testid="back-to-solutions" className="inline-flex items-center gap-2 font-mono2 text-[11px] tracking-[0.25em] uppercase text-[#57534E] hover:text-[#1C1917] transition-colors duration-150">
          <ArrowLeft className="w-3.5 h-3.5" /> All Roles
        </Link>
      </div>
      <PageHero overline={`Role · ${persona.group}`} title={persona.headline} sub={persona.intro} />

      <section className="border-b border-black/[0.07]" data-testid="persona-pains">
      ...
      <section className="border-b border-black/[0.07] bg-[#FFFFFF]" data-testid="persona-perspective">
        <div className="container-x py-20 md:py-28 grid lg:grid-cols-2 gap-16 items-start">
          <Reveal>
            <div className="surface-card rounded-md p-10 relative">
              ...
              <p className="font-mono2 text-[11px] tracking-[0.25em] uppercase text-[#57534E] mt-8">The {persona.name} Perspective</p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            ...
            <p className="text-[#57534E] text-sm mt-6 leading-relaxed max-w-md">
            ...
            {rel.map((r) => (
              ...
              >
                <div>
                  ...
                  <p className="text-[#57534E] text-sm mt-2">{r.headline}</p>
                </div>
