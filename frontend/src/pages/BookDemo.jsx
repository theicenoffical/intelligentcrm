      ...
      <section className="container-x pt-36 pb-24 md:pt-44 grid lg:grid-cols-2 gap-16 items-start" data-testid="book-demo-page">
        <div>
          <Reveal>
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-[-0.035em] leading-[1.0] text-[#1C1917]">
            ...
            <div className="mt-12 pt-10 border-t border-black/[0.07]">
              <p className="font-mono2 text-[11px] tracking-[0.25em] uppercase text-[#57534E] mb-4">Prefer to talk first?</p>
              <a href={SITE.phoneHref} data-testid="demo-phone-link" className="font-display text-2xl font-bold text-[#1C1917] hover:text-[#1C1917] transition-colors duration-150">{SITE.phone}</a>
              <p className="text-[#57534E] text-sm mt-2">{SITE.address}</p>
            </div>
          </Reveal>
        </div>
        <Reveal delay={0.15}>
          <div className="surface-card rounded-md p-8 md:p-10 lg:sticky lg:top-28">
            <h2 className="font-display text-2xl font-bold text-[#1C1917] mb-8 tracking-[-0.02em]">Request your demo</h2>
